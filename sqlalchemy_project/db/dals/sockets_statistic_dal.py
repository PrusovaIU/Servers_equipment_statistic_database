...
class SocketsStatisticDAL(DAL):
    ...
    async def add(self, server_id: int, port: int, status: str, direction: bool,
                  bytes_per_sec: int, packet_per_sec: int, crashed_packet_per_sec: int,
                  bytes_total: int, packets_total, crashed_packets_total):
        ...
        new_data = SocketsStatistic(
            ...
            crashed_packet_per_sec=crashed_packet_per_sec,
